...
print 'https://www.perlmonks.org/?node_id=289076', "\n";
...
sub new        # constructor, this method makes an object that belongs to class Number
{
  ...
  my $self = {};           # the internal structure we'll use to represent the data in our class is a hash reference
  print '$class is: ', $class, "\n";
  print '$self is:', $self, " before bless\n";
  bless( $self, $class );  # make $self an object of class $class
  print '$self is:', $self, " after bless\n";
